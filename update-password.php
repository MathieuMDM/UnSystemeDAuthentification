                ...
                if ($resultat==true) {
                    ...
                    if ($count==1) {
                        if ($new_password==$confirm_password) {
                            ...
                            if ($res2==true) {
                                $_SESSION['change-pwd'] = "<div class='success'>Le mot de passe a été changé avec succès. </div>";
                            ...
                            $_SESSION['pwd-not-match'] = "<div class='error'>Le mot de passe n'a pas été corrigé. </div>";
